            ...
            <div className={styles.controlContainer} style={{width: "400px"}}>
                ...
                <div style={{position:"relative", display:"block", textAlign: "center"}}>
                    <form action="" onChange={onCoordInputUpdate} style={{display:"inline-block"}}>
                        ...
                        <input id={"max_lat"} key={"max_lat"} type="number" step={stepsize} defaultValue={neCoord.lat}  className={styles.in}/>
                        <span className={styles.spacer}></span>
                        <br/>

                        <input id={"min_long"} key={"min_long"} type="number" step={stepsize} defaultValue={swCoord.lng} className={styles.in}/>
                        <span className={styles.spacer}></span>
                        <input id={"max_long"} key={"max_long"} type="number" step={stepsize} defaultValue={neCoord.lng} className={styles.in}/>
                        <br/>
                        <span className={styles.spacer}></span>
                        <input id={"min_lat"} key={"min_lat"} type="number" step={stepsize} defaultValue={swCoord.lat}  className={styles.in}/>
                        <span className={styles.spacer}></span>
